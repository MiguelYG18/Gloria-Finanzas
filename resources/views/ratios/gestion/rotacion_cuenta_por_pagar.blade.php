...
@section('content')
    @php
        ...
        //Total de Pasivos
        $ventas_2022 = abs($ventas->where('year', 2022)->first()->quantity ?? 0);
        $ventas_2023 = abs($ventas->where('year', 2023)->first()->quantity ?? 0);
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">Cuentas por Pagar Comerciales y Otras Cuentas por Pagar - 2022</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <label for="utilidad_bruta_2022" class="form-label">C. por Pagar Comerciales</label>
                        ...
                        <div class="col-md-4">
                            <label for="utilidad_bruta_2022" class="form-label">C. por Pagar a Entidades Relacionadas</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
                        ...
                        <div class="col-md-4">
                            <label for="utilidad_bruta_2022" class="form-label">Otras Cuentas por Pagar</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">R. Cuentas por Pagar - 2022</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <label for="ventas_2022" class="form-label">Costo de Ventas</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                La empresa paga a sus proveedores <strong>{{number_format($resultado_2022,2)}}</strong> veces en el periodo en relación a sus compras.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            <p class="card-text">La empresa tarda aproximadamente <strong>{{number_format(365/$resultado_2022,2)}}</strong> en pagar a sus proveedores..</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">Cuentas por Pagar Comerciales y Otras Cuentas por Pagar - 2023</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <label class="form-label">C. por Pagar Comerciales</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">C. por Pagar a Entidades Relacionadas</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Otras Cuentas por Pagar</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">R. Cuentas por Pagar - 2023</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <label for="ventas_2023" class="form-label">Costo de Ventas</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                La empresa paga a sus proveedores <strong>{{number_format($resultado_2023,2)}}</strong> veces en el periodo en relación a sus compras.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                        <div class="card-header">Rotación por Días</div>
                        <div class="card-body">
                            <p class="card-text">La empresa tarda aproximadamente <strong>{{number_format(365/$resultado_2023,2)}}</strong> en pagar a sus proveedores..</p>
                        </div>
                    </div>
                </div>
            </div>
