@extends('layouts.app')
@section('title', 'Solvencia Patrimonial a Largo Plazo')
@push('css')
    <style>
...
@section('content')
    <div class="row">
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">SOLVENCIA PATRIMONIAL A LARGO PLAZO - 2022</p>
                </div>
                <div class="card-body">
                    @php
                        //Total de Activos
                        ...
                        $resultado_2022 =  $pasivos_no_corrientes_totales_2022 / $patrimonio_totales_2022;
                        $resultado_2023 =  $pasivos_no_corrientes_totales_2023 / $patrimonio_totales_2023;
                    @endphp
                    <div class="row">
                        <div class="col-md-12">
                            <label for="pasivos_no_corrientes_totales_2022" class="form-label">Pasivo No Corriente</label>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            <p class="card-text">Significa que por cada sol de patrimonio la empresa tiene el compromisoa largo plazo de <strong>S/.{{number_format($resultado_2022,2)}}</strong> o que del <strong>{{number_format($resultado_2022 * 100,2)}}%</strong> está comprometido en deudas a largo plazo</p>                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">SOLVENCIA PATRIMONIAL A LARGO PLAZO - 2023</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="pasivos_no_corrientes_totales_2023" class="form-label">Pasivos No Corrientes</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
                        ...
                        <div class="col-md-12">
                            <label for="patrimonio_totales_2023" class="form-label">Patrimonio</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                        <div class="card-header">INTERPRETACIÓN</div>
                        <div class="card-body">
                          <p class="card-text">Significa que por cada sol de patrimonio la empresa tiene el compromisoa largo plazo de <strong>S/.{{number_format($resultado_2023,2)}}</strong> o que del <strong>{{number_format($resultado_2023 * 100,2)}}%</strong> está comprometido en deudas a largo plazo</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
    ...
    <script>
        am5.ready(function() {
            ...
            function updateCharts() {
                ...
                var result2022 = (pasivos_no_corrientes_totales_2022 / patrimonio_totales_2022);
                ...
                var result2023 = (pasivos_no_corrientes_totales_2023 / patrimonio_totales_2023);
