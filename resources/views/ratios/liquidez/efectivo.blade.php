@extends('layouts.app')
@section('title', 'Liquidez-Efectivo')
@push('css')
    <style>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">EFECTIVO - 2022</p>
                </div>
                <div class="card-body">
                    @php
                        //Efectivo
                        $efectivo_2022 = ($efectivo->firstWhere('year', 2022)->quantity ?? 0);
                        $efectivo_2023 = ($efectivo->firstWhere('year', 2023)->quantity ?? 0);
                        //Total de Pasivos
                        ...
                        $resultado_2022 = $efectivo_2022 / $pasivos_corrientes_totales_2022;
                        $resultado_2023 = $efectivo_2023 / $pasivos_corrientes_totales_2023;
                    @endphp
                    <div class="row">
                        <div class="col-md-12">
                            <label for="currentAssets" class="form-label">Efectivo y Equivalentes</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
                                <input readonly type="text" id="efectivo_2022" class="form-control" value="{{$efectivo_2022}}">
                            </div>
                        </div>
                        <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="row">
                    ...
                    <div class="card mb-3
                        ...
                        <div class="card-body">
                          <p class="card-text">
                            ...
                            Se puede apreciar la insuficiencia de efectivo para cubrir sus deudas a corto plazo.
                          </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="card {{ $resultado_2022 > 1 ? 'text-bg-danger' : 'text-bg-success' }} mb-3">
                            <div class="card-header">INTERPRETACIÓN</div>
                            <div class="card-body">
                                @if ($resultado_2022 > 1)
                                    @php
                                        $activo_ocioso_2022=$resultado_2022-1;
                                    @endphp
                                    <p class="card-text">
        ...
        <div class="col-md-3">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">EFECTIVO - 2023</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
                                <input readonly type="text" id="efectivo_2023" class="form-control" value="{{$efectivo_2023}}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label for="currentLiabilities" class="form-label">Pasivos Corrientes</label>
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="card {{ $resultado_2023 > 1 ? 'text-bg-danger' : 'text-bg-success' }} mb-3">
                            <div class="card-header">INTERPRETACIÓN</div>
                            <div class="card-body">
                                @if ($resultado_2023 > 1)
                                    @php
                                        $activo_ocioso_2023=$resultado_2023-1;
                                    @endphp
                                    <p class="card-text">
