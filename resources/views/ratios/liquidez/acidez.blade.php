...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">ACIDEZ - 2022</p>
                </div>
                <div class="card-body">
                    @php
                        //Total de Activos
                        ...
                        //Inventario
                        $inventario_2022 = ($inventario->firstWhere('year', 2022)->quantity ?? 0);
                        $inventario_2023 = ($inventario->firstWhere('year', 2023)->quantity ?? 0);
                        // Cálculo del resultado
                        $resultado_2022 = ($activos_corrientes_totales_2022 - $inventario_2022)/ $pasivos_corrientes_totales_2022;
                        $resultado_2023 = ($activos_corrientes_totales_2023 - $inventario_2023)/ $pasivos_corrientes_totales_2023;
                    @endphp
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <label for="currentAssets" class="form-label">Inventario</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text">S/.</span>
        ...
        <div class="col-md-3">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold">ACIDEZ - 2023</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    am5.ready(function() {
        ...
        function updateCharts() {
            ...
            var result2022 = ((activos_corrientes_totales_2022-inventario_2022) / pasivos_corrientes_totales_2022);
            ...
            var result2023 = ((activos_corrientes_totales_2023-inventario_2023) / pasivos_corrientes_totales_2023);
