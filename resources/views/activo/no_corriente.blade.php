@extends('layouts.app')
@section('title', 'Activos No Corrientes')
@push('css')
    <!--Alertas-->
    ...
    <div class="row">
                        ...
                        <table class="table my-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    $percentage2022 = $detail2022 ? number_format(($detail2022->quantity / 4633530) * 100, 2) : 'N/A';
                                    $percentage2023 = $detail2023 ? number_format(($detail2023->quantity / 4425971) * 100, 2) : 'N/A';
                                    @endphp
                                    <!--------------------------2022-------------------------------->
        ...
        <div class="col-md-6">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <canvas id="myPieChart2022" style="width: 100%; height: 300px;"></canvas>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <canvas id="myPieChart2023" style="width: 100%; height: 300px;"></canvas>
                </div>
            </div>
        </div>
        <div class="col-md-12">
...
@push('js')
    <script>
        ...
        const total2022 = 4633530;
        const total2023 = 4425971;
