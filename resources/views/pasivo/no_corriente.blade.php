@extends('layouts.app')
@section('title', 'Pasivos No Corrientes')
@push('css')
    <!--Alertas-->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @php
                                        ...
                                        $percentage2022 = $detail2022 ? number_format(($detail2022->quantity / 3056287) * 100, 2) : 'N/A';
                                        $percentage2023 = $detail2023 ? number_format(($detail2023->quantity / 2661399) * 100, 2) : 'N/A';
                                    @endphp
                                    <!--------------------------2022-------------------------------->
                                ...
                                <tr>
                                    ...
                                    <td class="text-success" style="text-align: center;">
                                        ...
                                        @elseif ($variacionabsoluta > 0)
                                            <span class="text-danger">{{ $percentage }} % <i class="fa-solid fa-arrow-up"></i></span>
                                        @else
                                            <span class="text-success">{{ $percentage }} % <i class="fa-solid fa-arrow-down"></i></span>
                                        @endif
...
@push('js')
    <script>
        ...
        const total2022 = 3056287;
        const total2023 = 2661399;
